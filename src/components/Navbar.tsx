            ...
            <div className="ml-10 flex items-baseline space-x-8">
              {navLinks.map((link) => (
                <button
                  ...
                  className="text-gray-300 hover:text-white px-3 py-2 text-sm font-medium transition-colors duration-200 hover:bg-purple-500/10 rounded-md cursor-pointer"
                >
                  {link.name}
                </button>
              ))}
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {navLinks.map((link) => (
              <button
                ...
                className="text-gray-300 hover:text-white block px-3 py-2 text-base font-medium transition-colors duration-200 hover:bg-purple-500/10 rounded-md cursor-pointer w-full text-left"
              >
                {link.name}
              </button>
            ))}
