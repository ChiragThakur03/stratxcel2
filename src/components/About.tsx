  ...
  return (
    <section id="about" className="relative z-10 py-20 px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Mission Statement */}
        <div className="bg-gradient-to-r from-purple-900/20 to-blue-900/20 border border-blue-500/30 rounded-2xl p-8 lg:p-12 mb-20">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-gradient-to-br from-blue-900/20 to-purple-900/10 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 text-center hover:border-blue-500/50 transition-all duration-300">
